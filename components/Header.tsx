                ...
                <div className="flex items-center justify-between w-full md:w-auto">
                  ...
                  <div className="-mr-2 flex items-center md:hidden">
                    <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center  hover:text-gray-500 hover:bg-gray-100  ">
                      <Image height={32} width={32} src={List} alt="Menu" />
                    </Popover.Button>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="rounded-lg h-[100vh] shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div className="px-5 pt-4 flex items-center justify-between">
                  ...
                  <div className="-mr-2">
                    <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center  hover:text-gray-500 hover:bg-gray-100">
                      <Image height={32} width={32} src={XIcon} alt="Fechar" />
                    </Popover.Button>
                  </div>
                </div>
                <div className="flex flex-col px-8 pt-2 pb-2 space-y-1 items-center gap-2 ">
                  {navigation.map((item) => (
                    <Link key={item.name} href={item.href} as={item.as}>
                      <Popover.Button className="text-center py-4 mt-24 rounded-md text-base font-bold  hover:text-gray-900 hover:bg-gray-200 w-full">
                        {item.name}
                      </Popover.Button>
                    </Link>
                  ))}
