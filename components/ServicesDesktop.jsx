      ...
      <div className="relative max-w-[1000px] mx-auto px-4 sm:px-6 lg:pb-16 xl:max-w-6xl">
        <div className="pt-12 md:pt-20">
          ...
          <div
            ...
            data-aos="fade-right"
          >
            <h1 className="text-4xl mb-4">Conheça nossos serviços</h1>
            <p className="text-xl text-gray-600">
              Temos a solução em engenharia elétrica que você precisa! Com
              excelência no atendimento e no acompanhamento de sua obra,
              proporcionamos a tranquilidade que você procura.
            </p>
          </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      Invista em energia solar e economize dinheiro gerando sua
