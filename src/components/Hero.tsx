...
export function Hero() {
    return (
        <div className="flex flex-col gap-6 px-4 mt-4">
            ...
            <p className="">
                Com a <span className="text-[#ffaa00] font-bold">Fótum</span>{" "}
                isso é possível! <br /> Peça já seu orçamento sem compromisso e
                comece a gerar a sua própria energia limpa e rentável!
            </p>
